...
async def TcPOnLine(ip, port, key, iv, AutHToKen, reconnect_delay=0.5):
    ...
    f"{get_random_color()}- Commands : @a "
    f"{xMsGFixinG('player_uid')} "
    f"{xMsGFixinG('909000001')}\n\n"
    f"[00FF00]Dev : @{xMsGFixinG('BLACK_Apis')}"
)
                                P = await SEndMsG(0 , message , OwNer_UiD , OwNer_UiD , key , iv)
                                await SEndPacKeT(whisper_writer , online_writer , 'ChaT' , P)
                            except:
...
"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = """[B][C][FFFF00]✨ ভন্ড রাজা BOT ✨
...
-> [FFFFFF]Join Req Pro Badge"""
                            ...
                            await asyncio.sleep(0.2)
                                                        ...
                                                        # Footer
                            footer = """[B][C][FFD700]⚠️ GUILD NOTICE ⚠️
[B][C][00FF00]✔ সবাই গিল্ড মেম্বারদের সাথে খেলবে
[B][C][00FF00]✔ সপ্তাহ শেষে Glory চেক হবে
[B][C][FF0000]✔ Glory সর্বনিম্ন ৫ হাজার করতে হবে
[B][C][00FFAA]🎯 সবাই একসাথে খেলুন
[B][C][00FF00]✅ Active = Safe
[B][C][FF0000]❌ Inactive = Kick

[B][C][FFD700]— Guild Management"""
...
async def MaiiiinE():
    Uid , Pw = '4387384745','C5F330F41538E0C7CD8324E6CCF33763686B8D50405FD28417EE29E722B69D52'
